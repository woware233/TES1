...
<form:form action="/TCES/coursesAction" method="post" modelAttribute="course">
			...
			<c:forEach items="${requestScope.courses}" var="cou">
				<tr>
					...
					<td class="td_border" align="center">
						<a href="javascript:deleteRecord('/TCES/deleteCourseByIdAction?Id=${cou.getId()}')">
							<img src="/TCES/images/wrong.gif" border="0"/>
						</a>
					</td>
					<td class="td_border" align="center">
						<a href="/TCES/selectByPrimaryKey?Id=${cou.getId()}">
							<img src="/TCES/images/edit.gif" border="0"/>
						</a>
					</td>				
